...
test.describe("Dashboard-Inhalte", () => {
  test("Admin legt Link und Neuigkeit an — erscheinen auf dem Dashboard", async ({
    ...
    await admin.getByRole("button", { name: "Link hinzufügen" }).click();
